  ...
  return (
    <>
      <motion.div
        ...
        animate={isOpen ? { opacity: 1, left: 0, transition: { duration: 0 } } : { opacity: 0, left: -800, transition: { duration: 0.5 } }}
        className="w-full h-screen backdrop-blur-sm z-49 overflow-hidden"
        onClick={toggle}
      ></motion.div>
